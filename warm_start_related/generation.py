...
from openai_related import gpt_generation, gpt_generation_with_image, gpt_generation_multi_turn, gpt_reasoning_generation, gpt_reasoning_generation_multi_turn
...
if __name__ == "__main__":
    ...
    if True:
        ...
        if 'gpt' in args.generation_model:
            ...
            raise ValueError(f"Model {args.generation_model} not supported. Only GPT models are supported.")
